# Modified from https://github.com/Rapptz/RoboDanny/blob/rewrite/cogs/utils/paginator.py
...
class HelpPaginator(Pages):
    ...
    def prepare_embed(self, entries, page, *, first=False):
        ...
        if self.is_bot:
            value ='For more help, join the official bot support server: https://discord.gg/yzyRUFr'
